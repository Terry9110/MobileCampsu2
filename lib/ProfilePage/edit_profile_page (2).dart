...
//   @override
//   void initState(){
//    fullNameEditingController  = new TextEditingController(text:'');
//    phoneNumberEditingController = new  TextEditingController(text:'');
//    userNameEditingController = new  TextEditingController(text:'');
...
//       firebaseUser
//           ?.updateEmail(editEmailController.text)
//           .then(
//             (value) =>{ 
//               message = 'Success',
...
//   FirebaseFires tore firebaseFirestore = FirebaseFirestore.instance;
//   User? user = _auth.currentUser;
