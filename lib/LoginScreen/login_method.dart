                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //START OF LOGIN WITH EMAIL ADDRESS SECTION!!//
                      InkWell(
                        onTap: () {
                        ...
                        child: Container(
                            ...
                            child: Center(
                                child: Text('Login In With An Email Address',
                                    style: GoogleFonts.poppins(
                                        fontWeight: FontWeight.w600,
                                        color: Colors.white,
                                        fontSize: 14)))),
                      ),
                      //END OF LOGIN WITH EMAIL ADDRESS SECTION!!//
                      const SizedBox(height: 40),
                      //START OF LOGIN WITH PHONE NUMBER SECTION!!//
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
